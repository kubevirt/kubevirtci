...
if [ -z $KUBEVIRTCI_PROVISION_CHECK ]; then
    ...
    IMAGES[k8s-1.18]="k8s-1.18@sha256:1eaf45423b34cc7a8dcce278706207b4adfdfe56179a91c63989df1d39e7e742"
    IMAGES[k8s-1.17]="k8s-1.17@sha256:4239183d6889ec57d0e72683d6edfbe0f4201f15aeb37a23b9f657aa0b17e788"
