...
if [ -z $KUBEVIRTCI_PROVISION_CHECK ]; then
    ...
    IMAGES[k8s-1.18]="k8s-1.18@sha256:af88b513d1b570167510666f71cba3cabb1d2323262835cf63c1a8a6a662e7cb"
    IMAGES[k8s-1.17]="k8s-1.17@sha256:ad49c2cc4166325e460173bae46cb90faf5f7ff0561a2086e193af910e8b0ff4"
